...
import { getCachedRejections, getCachedSyncLogs, getCachedUsers } from "@/server/cache/queries";
...
export async function SettingsContent({ currentUserId, currentUserRole }: SettingsContentProps) {
